...
export default function Home() {
  return <main><ScrollReveal/>
    ...
    <section className="cta" id="contact"><div className="container cta-grid"><div className="cta-copy"><p className="eyebrow">LET&apos;S BUILD SOMETHING GREAT</p><h2>Ready to Take Your Business <em>Digital?</em></h2><p>Tell us what you want to build. We&apos;ll turn the idea into a practical roadmap and a product made to grow.</p><div className="contact-row"><a href={`mailto:${siteConfig.email}`}>✉ {siteConfig.email}</a><a href={`https://wa.me/${siteConfig.phone.replace(/\D/g, "")}`}>◉ {siteConfig.phone}</a><span>◎ Worldwide</span></div></div><ContactForm email={siteConfig.email}/></div></section>
